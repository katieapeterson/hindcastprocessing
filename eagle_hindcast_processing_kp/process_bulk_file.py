...
def clean_name(sd):
	...
	"""
	saveFile = f'{sd}/Johnston_Atoll_wave_{Year}.h5'	
...
if __name__ == "__main__":
	...
	dataDir = '/projects/hindcastra/filepurgatory/johnstonAtoll'
	saveDir = '/scratch/kpeterso2/wave_processing/johnstonatoll'
