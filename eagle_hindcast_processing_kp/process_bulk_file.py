...
def scrape_files(path,shp=(1,12)):
	"""
...
def clean_name(sd):
	...
	"""
	saveFile = f'{sd}/Jarvis_Island_wave_{Year}.h5'	
...
if __name__ == "__main__":
	...
	dataDir = '/projects/hindcastra/filepurgatory/jarvisIsland'
	saveDir = '/scratch/kpeterso2/wave_processing/jarvisisland'
	year = '2020'
