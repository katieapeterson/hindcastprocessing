...
def clean_name(sd):
	...
	"""
	saveFile = f'{sd}/American_Samoa_wave_{Year}.h5'	
...
if __name__ == "__main__":
	...
	dataDir = '/projects/hindcastra/filepurgatory/americanSamoa'
	saveDir = '/scratch/kpeterso2/wave_processing/americansamoa'
